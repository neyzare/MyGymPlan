...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden h-16 items-end gap-4 rounded-3xl px-4 pb-3 md:flex",
        className
      )}
    >
      {items.map((item) => (
  ...
  return (
    <a href={href}>
      <motion.div
        ...
        className="relative flex aspect-square items-center justify-center rounded-2xl bg-neutral-800 hover:bg-neutral-700 transition-colors"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
