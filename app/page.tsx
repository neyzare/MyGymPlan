    ...
    <>
      <section className="mt-12 text-center px-4">
        <h1 className="text-4xl md:text-6xl font-bold leading-tight tracking-tight text-black max-w-4xl mx-auto">
          ...
          <span className="text-black">atteindre tes </span> <span className="text-blue-600">objectifs</span> et <span className="text-blue-600">progresser</span> <span className="text-black">durablement</span>.
        </h1>
